...
export function parseProjectVisibleRoles(
...
export function canViewProject(
  ...
  if (user?.id && project?.created_by && user.id === project.created_by)
    return true;
...
export function filterProjectsByInvite<T extends Partial<Project>>(
  projects: T[],
  user?: ProjectViewer,
): T[] {
